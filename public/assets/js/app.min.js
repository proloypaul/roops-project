        ...
        _createClass(t, [
            {
                ...
                value: function () {
                    ...
                    $(".button-menu-mobile").on("click", function (t) {    // using icon minimize the left side page
                        t.preventDefault(), r.body.toggleClass("sidebar-enable")
                    }),

                        $(".lg-button-menu-mobile").on("click", function (t) {
                            t.preventDefault(), r.body.toggleClass("lg-sidebar-enable")
                        }),
                        $("#side-menu").length &&
                            ...
                            $("#side-menu a").each(function () {
                                ...
                                this.href == t &&
                                    ($(this).addClass("active"),
                                        ...
                                        (t = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || t.addClass("menuitem-active"));
                            })),
                        $("#two-col-sidenav-main").length &&
                        ((n = $("#two-col-sidenav-main .nav-link")),
                            (a = $(".twocolumn-menu-item")),
                            (e = $(".twocolumn-menu-item .nav-second-level")),
                            ...
                            $("#two-col-menu a").each(function () {
                                ...
                                this.href == o &&
                                    ($(this).addClass("active"),
                                        ...
                                        (t = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || t.addClass("menuitem-active"),
                                        (e = null),
                                        (n = "#" + $(this).parents(".twocolumn-menu-item").attr("id")),
        ...
        return (
            _createClass(t, [
                ...
                },
                {
                    ...
                    value: function () {
                        var t = this;
                        null !== (e = document.querySelector(".right-bar-toggle")) &&
                            void 0 !== e &&
                            ...
                            $(".navbar-nav a").each(function () {
                                ...
                                this.href == e &&
                                    ($(this).addClass("active"),
                                        ...
                                        $(this).parent().parent().parent().parent().hasClass("mega-dropdown-menu")
                                            ? ($(this).parent().parent().parent().parent().parent().addClass("active"), $(this).parent().parent().parent().parent().parent().parent().addClass("active"))
                                            : (t = $(this).parent().parent()[0].querySelector(".dropdown-item")) &&
                                            ((e = window.location.href.split(/[?#]/)[0]), (t.href != e && !t.classList.contains("dropdown-toggle")) || t.classList.add("active")),
                                        (t = $(this).parent().parent().parent().parent().addClass("active").prev()).hasClass("nav-link") && t.addClass("active"));
                            }),
                            ...
                            n.addEventListener("click", function (t) {
                                ...
                                n.parentElement.classList.contains("nav-item") ||
                                    ((a = !0),
                                        ...
                                        ((e = n.parentElement.parentElement.parentElement.querySelector(".nav-link")).ariaExpanded = !0),
            ...
            _createClass(t, [
                {
                    ...
                    value: function () {
                        $(document).on("click", "body", function (t) {
                            1 !== $(t.target).closest("#top-search").length && $("#search-dropdown").removeClass("d-block"),
                                0 < $(t.target).closest(".right-bar-toggle, .right-bar").length ||
                                0 < $(t.target).closest(".left-side-menu, .side-nav").length ||
                                $(t.target).hasClass("button-menu-mobile") ||
                                0 < $(t.target).closest(".button-menu-mobile").length ||
    ...
    ThemeCustomizer = (function () {
        function t() {
            _classCallCheck(this, t),
                ...
                (this.defaultConfig = { leftbar: { color: "light", size: "default", position: "fixed" }, layout: { color: "light", size: "fluid", mode: "default" }, topbar: { color: "light" }, sidebar: { user: !0 } });
        }
        return (
            _createClass(t, [
                {
                    ...
                    value: function () {
                        ...
                        (e.leftbar.color = null !== (t = this.body.getAttribute("data-leftbar-color")) && void 0 !== t ? t : this.defaultConfig.leftbar.color),
                            (e.leftbar.size = null !== (t = this.body.getAttribute("data-leftbar-size")) && void 0 !== t ? t : this.defaultConfig.leftbar.size),
                            (e.leftbar.position = null !== (t = this.body.getAttribute("data-leftbar-position")) && void 0 !== t ? t : this.defaultConfig.leftbar.position),
                            (e.layout.color = null !== (t = this.body.getAttribute("data-layout-color")) && void 0 !== t ? t : this.defaultConfig.layout.color),
                            (e.layout.size = null !== (t = this.body.getAttribute("data-layout-size")) && void 0 !== t ? t : this.defaultConfig.layout.size),
                            (e.layout.mode = null !== (t = this.body.getAttribute("data-layout-mode")) && void 0 !== t ? t : this.defaultConfig.layout.mode),
                            (e.topbar.color = null !== (t = this.body.getAttribute("data-topbar-color")) && void 0 !== t ? t : this.defaultConfig.topbar.color),
                            (e.sidebar.user = null !== (t = this.body.getAttribute("data-sidebar-user")) && void 0 !== t ? t : this.defaultConfig.sidebar.user),
                            (this.defaultConfig = JSON.parse(JSON.stringify(e))),
                            (this.config = e),
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        document.querySelectorAll("input[name=leftbar-color]").forEach(function (e) {
                            ...
                            null !== (t = document.querySelector("#resetBtn")) &&
                            void 0 !== t &&
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        var t,
                            ...
                            l = this.config;
                        l &&
                            ((t = document.querySelector("input[type=checkbox][name=leftbar-color][value=" + l.leftbar.color + "]")),
                                (e = document.querySelector("input[type=checkbox][name=leftbar-size][value=" + l.leftbar.size + "]")),
                                (n = document.querySelector("input[type=checkbox][name=leftbar-position][value=" + l.leftbar.position + "]")),
                                (a = document.querySelector("input[type=checkbox][name=layout-color][value=" + l.layout.color + "]")),
                                (i = document.querySelector("input[type=checkbox][name=layout-size][value=" + l.layout.size + "]")),
                                (o = document.querySelector("input[type=checkbox][name=layout-mode][value=" + l.layout.type + "]")),
                                (r = document.querySelector("input[type=checkbox][name=topbar-color][value=" + l.topbar.color + "]")),
                ...
                o('[data-plugin="peity-pie"]').each(function (t, e) {
                    ...
                    o('[data-plugin="peity-donut"]').each(function (t, e) {
                        var n = o(this).attr("data-colors") ? o(this).attr("data-colors").split(",") : [],
                            a = o(this).attr("data-width") ? o(this).attr("data-width") : 20,
                            i = o(this).attr("data-height") ? o(this).attr("data-height") : 20;
                        o(this).peity("donut", { fill: n, width: a, height: i });
                    }),
